...
namespace Excellent_Taste.Controllers
{
    public class HomeController : Controller
    {
        ...
        public IActionResult Reservations(ReservationsViewModel ReservationsViewModel)
        {

            if (HttpContext.Session.GetString("UserId") != null)
            {
                Queries GetReservationOverview = new Queries();
                ReservationsViewModel.ReservationList = GetReservationOverview.RetrieveReservations();
        ...
        public IActionResult UpdateUser(UserEditViewModel UserEditViewModel)
        {
            Queries UpdateUser = new Queries();
            UpdateUser.UpdateUser(UserEditViewModel);
            return RedirectToAction("UserControl", "Home");
        }
        ...
        public IActionResult UserEdit(int UserId)
        {
            if (HttpContext.Session.GetString("UserId") != null)
            {
                ...
                User SingleUser = GetUsersForUpdate.RetrieveUser(UserId);

                UserEditViewModel UserEditViewModel = new UserEditViewModel();
                UserEditViewModel.SingleUser = SingleUser;
        ...
        public IActionResult AddReservationQuery(CreateReservationViewModel CreateReservationViewModel)
        {
            if (HttpContext.Session.GetString("UserId") != null)
            {
                Queries CreateReservationQuery = new Queries();
                CreateReservationQuery.CreateReservation(CreateReservationViewModel);
